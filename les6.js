...
let arrStr = ['Hello', 'world', 'lucky', 'house', 'Galaxy', 'Sun', 'function', 'stars', 'planet', 'Array', 'constructor', 'value', 'number', 'String', 'ok', 'green', 'function', 'happy']
// console.log(arrStr);


// 7  -- отсортировать его по алфавиту в восходящем порядке.
// let sortAZ = arrStr.sort((a, b) => {
